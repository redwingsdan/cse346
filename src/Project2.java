...
public class Project2 {
	...
	final static int N_SLOTS = 10000000;		//UNITS OF TIME USED FOR EACH PROBABILITY
	...
	{
		int currentSize = 0;			//NUMBER OF PACKETS IN QUEUE
		long totalTime = 0;				//TOTAL DELAY TIME FOR ALL PACKETS
		long totalServiced = 0;			//TOTAL NUMBER OF PACKETS THAT ARE SERVICED
		...
		for(double p = 0.02; p <= 1.00; p=p+0.02)
		{
			...
			{
				delay = ((long)totalTime / (double)totalServiced);	//CALCULATING DELAY
